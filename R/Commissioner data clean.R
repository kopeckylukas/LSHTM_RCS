...
{
  path <- "data/com_data/20-21/december-2020-CANCER-WAITING-TIMES-COMMISSIONER-WORKBOOK-PROVISIONAL.xlsx"
  period <- as.Date('2020-12-01') #yyy-mm-dd
  newName <- "data/com_done/december-2020.csv"
